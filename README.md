...
spreadsheet. Built for server-rendered sites (WordPress and similar) — no
...
| `link_issues.csv` | Broken links, broken images, and redirects (with hop count + final destination), joined back to pages via Page ID. |
...
Built by **Barry van Biljon** — [barry@turbopress.pro](mailto:barry@turbopress.pro) ·
[www.turbopress.pro](https://www.turbopress.pro)
